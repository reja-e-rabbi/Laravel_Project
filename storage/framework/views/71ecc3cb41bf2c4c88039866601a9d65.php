  ...
  <div class="row g-4">
      <div class="col-sm-12 col-xl-6">
          <div class="bg-light rounded h-100 p-4">
              <h6 class="mb-4">Add Expereance</h6>
              <form method="POST" action="<?php echo e(url('insert/experience')); ?>">
...
<div class="container-fluid pt-4 px-4">
  <div class="bg-light text-center rounded p-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
          <h6 class="mb-0">All Experience</h6>
          <a href="">Show All</a>
      </div>
        ...
        <table class="table text-start align-middle table-bordered table-hover mb-0">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-sm btn-primary" id="click" data-id="<?php echo e($item->sl); ?>" data-type="edu">Delete</a>
                </td>
              </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\htdocs\laravelapp.me\resources\views/Admin/experience.blade.php ENDPATH**/ ?>